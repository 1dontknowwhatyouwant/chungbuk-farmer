...
export default function CenterFeedback({ loading, error, empty, onRetry }: CenterFeedbackProps) {
  if (loading) {
    return <div className="rounded-2xl bg-white/80 px-5 py-10 text-center text-sm text-[#6d7a7e]">불러오는 중입니다.</div>;
  }
  if (error) {
    return (
